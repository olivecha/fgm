...
class PickleCounterflowTwinPremixedFlame(object):
    """
    A class to converting cantera FreeFlame
    objects to picklable objects
    """
    ...
    def __init__(self, source, phi, fuel, air=None):
        ...
        self.X = source.X
        self.velocity = source.velocity
        self.spread_rate = source.spread_rate
        ...
        self.Z = self.local_Z()
        self.phi = self.local_phi()
        self.srate = self.compute_strain_rate()
    ...
    def compute_strain_rate(self):
        """Compute the local strain rate
        as the flame normal velocity gradient"""
        return np.gradient(self.velocity, self.grid)

class PickleCounterflowPremixedFlame(object):
    """
    A class to converting cantera FreeFlame
    objects to picklable objects
    """
